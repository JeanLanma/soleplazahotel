    ...
    <div class="swiper-wrapper hero-bg bg-cover w-full h-screen relative">
        ...
        <div class="swiper-slide">
            ...
            <div class="text-white text-center flex flex-col justify-center gap-3 h-full z-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div class="mx-auto">
                    <img class="w-60" src="{{ asset('assets/logo.png') }}" alt="Logo Sole Plaza Hotel">
                </div>
                ...
                🏨 ¡Bienvenido a Sole Plaza Hotel en el corazón de la ciudad! Habitaciones impecables 🛏️, servicio 24/7 🌟, servicios básicos que necesitas para tu estancia cómoda. Además, ofrecemos emocionantes tours 🚶‍♂️ por los lugares más visitados de la ciudad.
                </p>
